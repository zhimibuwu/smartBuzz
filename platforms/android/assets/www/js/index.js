var googleapi = {
    ...
    //calendar: function(options) {
        //return $.getJSON('https://www.googleapis.com/calendar/v3/users/me/calendarList?minAccessRole=writer&access_token=', options);
    //    return $.post('https://www.googleapis.com/calendar/v3/calendars/calendarId/events/import', options);
    //}
};
...
var app = {
    ...
    showGreetView: function() {
        ...
        googleapi.getToken({
            ...
            return googleapi.calendar({ access_token: data.access_token });
        }).done(function(user) {
